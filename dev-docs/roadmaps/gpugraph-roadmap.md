...
The [GPU compute roadmap](./compute-roadmap.md) owns the cross-cutting execution, PLOOR,
fragmentation, DataFrame, streaming, and interoperability tranches. Its numbering is independent
of the domain phases below; package extraction must share the graduation contracts in phase 7.
