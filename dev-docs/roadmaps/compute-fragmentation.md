# GPU compute: make fragmentation inexpensive

**Status:** First block landed in [#3292](https://github.com/visgl/luma.gl/pull/3292).
This is tranche 3 in the [current GPU compute roadmap](./compute-roadmap.md); remaining debt below is open.
