...
const GPU_MEMORY_DOCS_TABS: GpuMemoryDocsTab[] = [
  {id: 'gpu-memory', label: 'GPU Memory', href: 'https://luma.gl/docs/api-guide/gpu/gpu-memory'},
  {id: 'gpu-buffers', label: 'GPU Buffers', href: 'https://luma.gl/docs/api-guide/gpu/gpu-buffers'},
  {
    id: 'gpu-memory-layouts',
    label: 'Memory Layouts',
    href: 'https://luma.gl/docs/api-guide/gpu/gpu-memory-layouts'
  },
  {
    id: 'gpu-storage-buffers',
    label: 'Storage Buffers',
    href: 'https://luma.gl/docs/api-guide/gpu/gpu-storage-buffers'
  }
];
