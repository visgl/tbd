...
const WEBGL_DOCS_TABS: WebGLDocsTab[] = [
  {id: 'overview', label: 'Overview', href: 'https://luma.gl/docs/api-reference/webgl'},
  {id: 'constants', label: 'Constants', href: 'https://luma.gl/docs/api-reference/webgl/constants'},
  {id: 'webgpu', label: 'WebGPU adapter', href: 'https://luma.gl/docs/api-reference/webgpu'}
];
