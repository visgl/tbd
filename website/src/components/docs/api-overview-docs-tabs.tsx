...
const API_OVERVIEW_DOCS_TABS: ApiOverviewDocsTab[] = [
  {id: 'overview', label: 'Choose a layer', href: 'https://luma.gl/docs/api-guide'},
  {id: 'layers', label: 'How layers fit', href: 'https://luma.gl/docs/api-guide/luma-layers'},
  {
    id: 'api-design',
    label: 'Design philosophy',
    href: 'https://luma.gl/docs/api-guide/background/api-design'
  },
  {
    id: 'learning-resources',
    label: 'Learning resources',
    href: 'https://luma.gl/docs/api-guide/background/learning-resources'
  },
  {
    id: 'webgpu-vs-webgl',
    label: 'WebGPU vs WebGL',
    href: 'https://luma.gl/docs/api-guide/background/webgpu-vs-webgl'
  }
];
