...
const TEST_UTILS_DOCS_TABS: TestUtilsDocsTab[] = [
  {id: 'overview', label: 'Overview', href: 'https://luma.gl/docs/api-reference/test-utils'},
  {
    id: 'snapshot-test-runner',
    label: 'SnapshotTestRunner',
    href: 'https://luma.gl/docs/api-reference/test-utils/snapshot-test-runner'
  },
  {id: 'testing-guide', label: 'Testing guide', href: 'https://luma.gl/docs/developer-guide/testing'}
];
