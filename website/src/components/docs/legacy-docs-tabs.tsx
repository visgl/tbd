...
const LEGACY_DOCS_TABS: LegacyDocsTab[] = [
  {id: 'porting-guide', label: 'Porting', href: 'https://luma.gl/docs/legacy/porting-guide'},
  {id: 'legacy-upgrade-guide', label: 'Upgrade', href: 'https://luma.gl/docs/legacy/legacy-upgrade-guide'},
  {id: 'legacy-whats-new', label: "What's New", href: 'https://luma.gl/docs/legacy/legacy-whats-new'}
];
