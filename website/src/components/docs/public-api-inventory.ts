...
export const PUBLIC_PACKAGE_API_INVENTORY: readonly PublicPackageDocumentation[] = [
  {
    ...
    documentation: {kind: 'generated', routePrefix: 'https://luma.gl/docs/api-reference/generated/core'}
  },
  {
    packageName: '@luma.gl/engine',
    entryPoint: 'modules/engine/src/index.ts',
    documentation: {kind: 'generated', routePrefix: 'https://luma.gl/docs/api-reference/generated/engine'}
  },
  {
    packageName: '@luma.gl/shadertools',
    entryPoint: 'modules/shadertools/src/index.ts',
    documentation: {kind: 'generated', routePrefix: 'https://luma.gl/docs/api-reference/generated/shadertools'}
  },
  {
    packageName: '@luma.gl/constants',
    entryPoint: 'modules/constants/src/index.ts',
    documentation: {kind: 'curated', defaultRoute: 'https://luma.gl/docs/api-reference/constants'}
  },
  {
    ...
    documentation: {
      kind: 'curated',
      defaultRoute: 'https://luma.gl/docs/api-reference/effects',
      routesBySourcePrefix: {
        'passes/postprocessing': 'https://luma.gl/docs/api-reference/shadertools/shader-passes/image-processing',
        'passes/screen-space': 'https://luma.gl/docs/api-reference/effects'
      }
    }
  },
  {
    ...
    documentation: {
      kind: 'curated',
      defaultRoute: 'https://luma.gl/docs/api-reference/gltf',
      routesBySourcePrefix: {
        animation: 'https://luma.gl/docs/api-reference/gltf/gltf-animation',
        'parsers/parse-gltf-animations': 'https://luma.gl/docs/api-reference/gltf/gltf-animation',
        pbr: 'https://luma.gl/docs/api-reference/gltf/gltf-materials',
        'gltf-instanced': 'https://luma.gl/docs/api-reference/gltf/gltf-animated-crowd'
      }
    }
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'curated',
      defaultRoute: 'https://luma.gl/docs/api-reference/test-utils',
      routesBySourcePrefix: {
        'snapshot-test-runner': 'https://luma.gl/docs/api-reference/test-utils/snapshot-test-runner'
      }
    }
  },
  {
    ...
    documentation: {kind: 'curated', defaultRoute: 'https://luma.gl/docs/api-reference/webgl'}
  },
  {
    packageName: '@luma.gl/webgpu',
    entryPoint: 'modules/webgpu/src/index.ts',
    documentation: {kind: 'curated', defaultRoute: 'https://luma.gl/docs/api-reference/webgpu'}
  }
];
