...
export const EXPERIMENTAL_DOCS_TAB_GROUPS: readonly DocsTabGroup<ExperimentalDocsTabId>[] = [
  {
    ...
    tabs: [{id: 'overview', label: 'Overview', href: 'https://luma.gl/docs/api-reference/experimental'}]
  },
  {
    id: 'scene-rendering',
    label: 'Scene rendering',
    tabs: [
      {id: 'scene-renderer', label: 'Scene Renderer', href: 'https://luma.gl/docs/api-reference/experimental/scene-renderer'},
      {id: 'deferred-scene-renderer', label: 'Deferred Scenes', href: 'https://luma.gl/docs/api-reference/experimental/deferred-scene-renderer'},
      {id: 'pbr-environment', label: 'PBR Environments', href: 'https://luma.gl/docs/api-reference/experimental/pbr-environment'}
    ]
  },
  {
    id: 'gpu-project',
  ...
  },
  {
    ...
    tabs: [
      {id: 'g-buffer', label: 'GBuffer', href: 'https://luma.gl/docs/api-reference/experimental/g-buffer'},
      {id: 'deferred-lighting', label: 'Deferred Lighting', href: 'https://luma.gl/docs/api-reference/experimental/deferred-lighting'},
      {id: 'clustered-lighting', label: 'Clustered Lighting', href: 'https://luma.gl/docs/api-reference/experimental/clustered-lighting'},
      {id: 'shadow-map-renderer', label: 'Shadow Maps', href: 'https://luma.gl/docs/api-reference/experimental/shadow-map-renderer'}
    ]
  },
  {
    ...
    tabs: [
      {id: 'spectral-caustics-renderer', label: 'Spectral Caustics', href: 'https://luma.gl/docs/api-reference/experimental/spectral-caustics-renderer'},
      {id: 'glass-material', label: 'Glass', href: 'https://luma.gl/docs/api-reference/experimental/glass-material'},
      {id: 'reflective-material', label: 'Reflective', href: 'https://luma.gl/docs/api-reference/experimental/reflective-material'},
      {id: 'a-buffer-renderer', label: 'A-Buffer', href: 'https://luma.gl/docs/api-reference/experimental/a-buffer-renderer'},
      {id: 'wboit-renderer', label: 'WBOIT', href: 'https://luma.gl/docs/api-reference/experimental/wboit-renderer'}
    ]
  },
  {
    id: 'simulation',
