...
const GLTF_DOCS_TABS: GltfDocsTab[] = [
  {id: 'overview', label: 'Overview', href: 'https://luma.gl/docs/api-reference/gltf'},
  {id: 'materials', label: 'Materials', href: 'https://luma.gl/docs/api-reference/gltf/gltf-materials'},
  {
    id: 'native-extensions',
    label: 'Native Extensions',
    href: 'https://luma.gl/docs/api-reference/gltf/gltf-native-extensions'
  },
  {id: 'animation', label: 'Animation', href: 'https://luma.gl/docs/api-reference/gltf/gltf-animation'},
  {
    id: 'animated-crowd',
    label: 'Animated Crowd',
    href: 'https://luma.gl/docs/api-reference/gltf/gltf-animated-crowd'
  },
  {id: 'interchange', label: 'Interchange', href: 'https://luma.gl/docs/api-reference/gltf/gltf-interchange'},
  {id: 'extensions', label: 'Extensions', href: 'https://luma.gl/docs/api-reference/gltf/gltf-extensions'}
];
