...
const MODULE_DETAILS = {
  core: {
    ...
    apiHref: 'https://luma.gl/docs/api-reference/generated/core',
    guideHref: 'https://luma.gl/docs/api-guide/gpu',
    cookbookHref: 'https://luma.gl/docs/api-guide/gpu/cookbook',
  ...
  engine: {
    ...
    apiHref: 'https://luma.gl/docs/api-reference/generated/engine',
    guideHref: 'https://luma.gl/docs/api-guide/engine',
    cookbookHref: 'https://luma.gl/docs/api-guide/engine/cookbook',
  ...
  shadertools: {
    ...
    apiHref: 'https://luma.gl/docs/api-reference/generated/shadertools',
    guideHref: 'https://luma.gl/docs/api-guide/shaders',
    cookbookHref: 'https://luma.gl/docs/api-guide/shaders/cookbook',
