...
export const GPGPU_DOCS_TAB_GROUPS: DocumentationTabGroup<GPGPUDocsTabId>[] = [
  ...
  },
  {
    ...
    tabs: [
      {id: 'precision-guide', label: 'Precision guide', href: 'https://luma.gl/docs/api-guide/shaders/gpu-floating-point-precision'},
      {id: 'fp64', label: 'fp64', href: 'https://luma.gl/docs/api-reference/shadertools/shader-modules/fp64'},
      {id: 'fp64-arithmetic', label: 'fp64 arithmetic', href: 'https://luma.gl/docs/api-reference/shadertools/shader-modules/fp64-arithmetic'}
    ]
  }
];
