...
[Core GPU guide](https://luma.gl/docs/api-guide/gpu) introduces those concepts.
...
| One explicit buffer or texture computation | [Engine compute helpers](https://luma.gl/docs/api-guide/engine/transforms) |
...
- [GPU floating-point precision](https://luma.gl/docs/api-guide/shaders/gpu-floating-point-precision)
