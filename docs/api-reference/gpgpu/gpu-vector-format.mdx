...
<GPUDataDocsTabs active="vector-format" />
...
[`GPUVector`](/docs/api-reference/gpgpu/gpu-vector). [`GPUData`](/docs/api-reference/gpgpu/gpu-data)
...
[`VertexFormat`](https://luma.gl/docs/api-reference/core/vertex-formats) strings:
