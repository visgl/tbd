...
It internally builds a [`Model`](https://luma.gl/docs/api-reference/engine/model) plus a `TransformFeedback` object and uses them to run buffer-to-buffer transforms.
