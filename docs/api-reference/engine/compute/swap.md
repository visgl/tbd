...
It is used by higher-level engine utilities such as [`ShaderPassRenderer`](https://luma.gl/docs/api-reference/engine/passes/shader-pass-renderer) and is also exported directly for application code.
