...
import {ArrowGeoArrowExample, ArrowRenderingDocsExample} from '@site/src/examples';
...
- `makeGPUSplatDataFromArrow()` prepares independently owned Gaussian splat batches for
  [`@luma.gl/splats`](https://luma.gl/docs/api-reference/splats), decoding GraphDECO encodings without
