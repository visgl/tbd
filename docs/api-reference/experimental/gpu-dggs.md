...
The same command-graph operation powers the family-specific [`gpu-h3`](https://luma.gl/docs/api-reference/experimental/gpu-h3) and
[`gpu-a5`](https://luma.gl/docs/api-reference/experimental/gpu-a5) modules. Use those typed adapters when the grid is known in advance. Use
