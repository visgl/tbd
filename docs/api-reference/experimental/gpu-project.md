...
See [WebGPU Geospatial Kernels](https://luma.gl/docs/api-reference/experimental/geospatial),
[GPU spatial query benchmarks](/docs/api-reference/experimental/gpu-core/gpu-spatial-query-benchmark),
and [GPU floating-point precision](https://luma.gl/docs/api-guide/shaders/gpu-floating-point-precision) for related
