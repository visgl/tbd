...
are exported from `@luma.gl/experimental/gpu-trace`; the underlying generic aggregations remain
[`GPUGroupAggregation`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-group-aggregation) and
[`GPUHistogram`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-histogram).
