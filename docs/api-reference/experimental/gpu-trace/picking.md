...
<ExperimentalDocsTabs active="trace-picking" />
...
[`@luma.gl/experimental/gpu-trace`](/docs/api-reference/experimental/gpu-trace) submodule because its
...
<GPUOperationContract operation="gpu-trace-picking" />
...
[`GPUTraceInteraction`](https://luma.gl/docs/api-reference/experimental/gpu-trace/interaction) already produces exclusive-scanned thread offsets
