...
Use [`GPUGridBinning`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-grid-binning) for population or occupancy alone. Use
[`GPUGroupAggregation`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-group-aggregation) when rows already carry categorical IDs rather
...
Counts remain independently available from [`GPUGridBinning`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-grid-binning) when an
