...
operations. Use it after the [first-graph tutorial](https://luma.gl/docs/api-reference/experimental/gpu-core/tutorial) and before reading individual API
...
**Pipeline neighborhood:** [`GPUMask`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-mask) → [`GPUScan`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-scan) →
[`GPUCompaction`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-compaction) → [`DrawCommandBuffer`](https://luma.gl/docs/api-reference/experimental/gpu-core/draw-command-buffer)
...
- **Common mistake:** treating every output slot as valid. Only the prefix named by the GPU-written
  count is published.
- **Shortcut:** [`GPUVisibilityWorkflow`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-visibility-workflow) packages common predicate-mask
  composition, stable IDs, compaction, and count publication.

## Aggregate a selection

**Pipeline neighborhood:** source-aligned mask → [`GPUReduction`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-reduction),
[`GPUHistogram`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-histogram), or [`GPUGroupAggregation`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-group-aggregation) → bounded
chart/stat output
...
**Pipeline neighborhood:** keys and optional values → [`GPUSort`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-sort) or
[`GPUSegmentedSort`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-segmented-sort) → ordered GPU consumer
...
**Pipeline neighborhood:** positions → [`GPUGridIndex`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-grid-index) or [`GPUBVH`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-bvh)
→ [`GPUGridIndexQuery`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-grid-index-query) or [`GPUBVHQuery`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-bvh-query) → bounded IDs
...
**Pipeline neighborhood:** rendered canonical IDs → [`GPUIndexPickingTarget`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-index-picking-target)
→ [`GPUReadbackRing`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-readback-ring) → hover parameter → normal render
...
[Conditional execution](https://luma.gl/docs/api-reference/experimental/gpu-core/concepts#conditional-execution) for the exact ownership rules.
...
See [Resumable execution and work budgets](https://luma.gl/docs/api-reference/experimental/gpu-core/concepts#resumable-execution-and-work-budgets).
...
See [Composition levels](https://luma.gl/docs/api-reference/experimental/gpu-core/concepts#composition-levels) and the
[`GPUCommandGraph` extension contracts](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-command-graph#extension-libraries).

## Related APIs

- [GPU Core tutorial](https://luma.gl/docs/api-reference/experimental/gpu-core/tutorial) explains mask, scan, compaction, and indirect drawing visually.
- [Execution and composition](https://luma.gl/docs/api-reference/experimental/gpu-core/concepts) defines ownership, hazards, conditions, budgets, and
  instrumentation.
- [`GPUCommandGraph`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-command-graph) is the complete construction and execution reference.
