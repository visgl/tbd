...
- [GPU Core cookbook](https://luma.gl/docs/api-reference/experimental/gpu-core/recipes) starts from application outcomes rather than individual classes.
- [`GPUCommandGraph`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-command-graph) documents construction and compiled execution.
- [`GPUTextureHistory`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-texture-history) manages rotating retained texture state.
- [`GPUReadbackRing`](https://luma.gl/docs/api-reference/experimental/gpu-core/gpu-readback-ring) supports bounded asynchronous readback.
