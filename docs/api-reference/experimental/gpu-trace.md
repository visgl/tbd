...
- [GPU Graph](https://luma.gl/docs/api-reference/experimental/gpu-graph) provides general graph analytics without trace-specific semantics.
- [GPU Dataframe](https://luma.gl/docs/api-reference/experimental/gpu-dataframe) provides columnar aggregation and comparison building blocks.
