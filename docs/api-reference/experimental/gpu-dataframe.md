...
See the [operations reference](https://luma.gl/docs/api-reference/experimental/gpu-dataframe-operations) for detailed execution and ownership contracts.
...
- [GPU Crossfilter](https://luma.gl/docs/api-reference/experimental/gpu-crossfilter) composes linked interactive selections.
